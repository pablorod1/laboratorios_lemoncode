'use strict';
/* build-hook-start *//*00001*/try { require('c:\\Users\\spyde\\.vscode\\extensions\\wallabyjs.console-ninja-1.0.360\\out\\buildHook\\index.js').default({tool: 'jest', checkSum: '20cd0ac199ed3f90ee30ceUV0eVE0BA10GVwcCCVRWB1ICBQcB', mode: 'build'}); } catch(cjsError) { try { import('file:///c:/Users/spyde/.vscode/extensions/wallabyjs.console-ninja-1.0.360/out/buildHook/index.js').then(m => m.default.default({tool: 'jest', checkSum: '20cd0ac199ed3f90ee30ceUV0eVE0BA10GVwcCCVRWB1ICBQcB', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
